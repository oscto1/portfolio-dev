...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function jc(e,t,n){let r=new Float32Array(_c),i=new K(0,1,0);return new Ao({name:`SphericalGaussianBlur`,defines:{n:_c,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Pc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mc(){return new Ao({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Pc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Nc(){return new Ao({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pc(),fragmentShader:`
	...
	`}var Fc=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)c=0,l-=o;else{let e=Kf(t,a,c,l,n);r==`tb`?(c=0,l+=n.ascender*a):c+=e.offsetX,s.push(e.path)}}return s}function Kf(e,t,n,r,i){let a=i.glyphs[e]||i.glyphs[`?`];if(!a){console.error(`THREE.Font: character "`+e+`" does not exists in font family `+i.familyName+`.`);return}let o=new tc,s,c,l,u,d,f,p,m;if(a.o){let e=a._cachedOutline||(a._cachedOutline=a.o.split(` `));for(let i=0,a=e.length;i<a;)switch(e[i++]){case`m`:s=e[i++]*t+n,c=e[i++]*t+r,o.moveTo(s,c);break;case`l`:s=e[i++]*t+n,c=e[i++]*t+r,o.lineTo(s,c);break;case`q`:l=e[i++]*t+n,u=e[i++]*t+r,d=e[i++]*t+n,f=e[i++]*t+r,o.quadraticCurveTo(d,f,l,u);break;case`b`:l=e[i++]*t+n,u=e[i++]*t+r,d=e[i++]*t+n,f=e[i++]*t+r,p=e[i++]*t+n,m=e[i++]*t+r,o.bezierCurveTo(d,f,p,m,l,u);break}}return{offsetX:a.ha*t,path:o}}var qf=new Cd,Jf=new Uf;async function Yf(e,t){let n=await qf.loadAsync(e);return t.add(n.scene),n.scene}function Xf(e){let t=e.geometry;t.computeBoundingBox();let n=t.boundingBox,r=n.max.x-n.min.x,i=n.max.y-n.min.y,a=n.max.z-n.min.z;t.translate(-r/2,-i/2,-a/2)}function Zf(e,t,n,r){let i=new Na,a=-e/2,o=-t/2;i.moveTo(a+r,o),i.lineTo(a+e-r,o),i.quadraticCurveTo(a+e,o,a+e,o+r),i.lineTo(a+e,o+t-r),i.quadraticCurveTo(a+e,o+t,a+e-r,o+t),i.lineTo(a+r,o+t),i.quadraticCurveTo(a,o+t,a,o+t-r),i.lineTo(a,o+r),i.quadraticCurveTo(a,o,a+r,o);let s=new Zr(new vo(i,{depth:n,bevelEnabled:!1}),new Mo({color:15779883}));return s.rotation.x=-Math.PI/2,s}var Qf=Zf(23,7,3,1);Qf.castShadow=!0,Cf.add(Qf),Jf.load(`fonts/dongle/Dongle_Bold.json`,e=>{let t=new Zr(new Hf(`oscar`,{font:e,size:9,depth:1.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.08,bevelSize:.07,bevelSegments:3}),new Mo({color:16777215}));sp(t),Xf(t),t.position.set(Qf.position.x,4,Qf.position.z),Cf.add(t)}),Jf.load(`fonts/Finesse-Oblique/FinesseOblique_Regular.json`,e=>{let t=new Zr(new Hf(`Castillejo`,{font:e,size:6,depth:0,curveSegments:12,bevelEnabled:!0,bevelThickness:.08,bevelSize:.07,bevelSegments:3}),new Mo({color:16777215}));sp(t),Xf(t),t.position.set(Qf.position.x,.1,6),t.receiveShadow=!0,Cf.add(t)});var $f=await Yf(`models/Forklift.glb`,Cf);$f.position.set(0,0,14),$f.rotation.y=.78,$f.scale.set(1,1,1);var ep;$f.castShadow=!0;var tp=await Yf(`models/Fork.glb`,$f);tp.position.set(0,.3,3.1),$f.traverse(e=>{if(e.isMesh){var t;e.castShadow=!0,e.name===`Cube`&&((t=e.parent)==null?void 0:t.name)===`Base_Car`&&(ep=e)}});var np=1024,rp=new Zr(new xo(np,np),new So({opacity:.3}));sp(rp),rp.receiveShadow=!0,Cf.add(rp);var ip=new Kn().setFromObject(ep),ap=new Kn().setFromObject(Qf),op=new ec(ip,16711680);Cf.add(op);function sp(e){e.rotation.x=-Math.PI/2}var cp=0,lp=.03,up=.95,dp=.8,fp=new K,pp=3;function mp(e,t,n){let r=n*60,i=!!e.a-+!!e.d+-t.turn;(e.w||t.forward<0)&&(cp+=lp*Math.max(1,t.forward)*r),(e.s||t.forward>0)&&(cp-=lp*Math.max(1,t.forward)*r);let a=tp.position;(e.i||t.rise)&&a.y<=4&&tp.position.set(0,a.y+=.15*r,3.1),(e.k||t.lower)&&a.y>=.3&&tp.position.set(0,a.y-=.15*r,3.1),cp*=up**+r;let o=.03*Math.min(Math.abs(cp)/dp,1)*r;fp.set(0,0,1).applyQuaternion($f.quaternion);let s=fp.clone().multiplyScalar(cp*r),c=$f.position.clone();$f.position.add(s),hp(),ip.intersectsBox(ap)&&($f.position.copy(c),cp*=.3,$f.position.x+=s.x,$f.position.z+=s.z,hp(),ip.intersectsBox(ap)&&($f.position.x-=s.x*pp,$f.position.z-=s.z*pp)),$f.rotation.y+=i*o*Math.sign(cp),$f.position.x=Et.clamp($f.position.x,-Df.width/2,Df.width/2),$f.position.z=Et.clamp($f.position.z,0,Df.height)}function hp(){ip.setFromObject(ep),ip.expandByScalar(-.1)}var gp={1:{en:`Games`,es:`Juegos`},2:{en:`Software projects`,es:`Proyectos de software`}},_p=[{id:1,year:`2025 - 2026`,title:{en:`Forkfest`,es:`Forkfest`},category:1,description:{en:`C#, Multiplayer application with client-server synchronization and gameplay systems implemented using Unity NGO.`,es:`Aplicación multijugador en C# con sincronización cliente-servidor y sistemas de juego implementado usando Unity NGO.`},tech:[`C#`,`Unity`,`NGO`],cta:{en:`Check updates`,es:`Ver avances`},link:`https://www.instagram.com/olliqadev/`,img:`img/forkfest/thumbnail.png`,video:`img/forkfest/forkfest.mp4`},{id:2,year:`2023`,title:{en:`Math Slopes`,es:`Math Slopes`},category:1,description:{en:`Browser-based application built with Phaser (JavaScript), implementing game state management, input handling, scoring logic, and dynamic difficulty.`,es:`Aplicación para navegador desarrollada con Phaser (JavaScript), que implementa la gestión de estados de juego, manejo de entradas, lógica de puntuación y dificultad dinámica.`},tech:[`PhaserJS`],cta:{en:`Try now`,es:`Probar ahora`},link:`project/ski_slopes/index.html`,img:`img/ski/1.png`,video:`img/ski/1.mp4`},{id:3,year:`2021`,title:{en:`Unity Arcade`,es:`Arcade Unity`},category:1,description:{en:`C#, Unity project recreating some classic arcade mechanics , implementing input handling, collision detection, scoring systems, and basic UI logic.`,es:`Proyecto en C# y Unity que recrea mecánicas de algunos juegos arcade e implementa el manejo de entradas, la detección de colisiones y lógica de interfaz de usuario.`},tech:[`C#`,`Unity`],cta:{en:`Try now`,es:`Probar ahora`},link:`Arcade/arcade.html`,img:`img/arcade/arcade1.png`,video:`img/arcade/arcade1.mp4`},{id:4,year:`2025`,title:{en:`Sort Algorithms`,es:`Algoritmos de ordenamiento`},category:2,description:{en:`Interactive visualization tool demonstrating sorting algorithms (Merge, Quick, Heap, Bubble), including step-by-step execution.`,es:`Herramienta de visualización interactiva que muestra algoritmos de ordenamiento (Merge, Quick, Heap, Bubble), con ejecución paso a paso.`},tech:[`Javascript`],cta:{en:`Try now`,es:`Probar ahora`},link:`project/sort_visualizer/index.html`,img:`img/sort_visualizer/1.png`,video:`img/sort_visualizer/1.mp4`},{id:5,year:`2021`,title:{en:`Messapp`,es:`Messapp`},category:2,description:{en:`Chat room application built with React and Firebase, implementing messaging, Google authentication, and cloud-based data synchronization.`,es:`Aplicación de salas de chat desarrollada con React y Firebase, que incluye funciones de mensajería, autenticación de Google y sincronización de datos en la nube.`},tech:[`React`,`Firebase`],cta:{en:`Try now`,es:`Probar ahora`},link:`https://messa-69e78.firebaseapp.com/`,img:`img/messaging/Messa2-min.png`,video:``}],vp=new URLSearchParams(window.location.search).get(`type`),yp=null;async function bp(){if(!yp){let e=await(await fetch(`img/icons/play-video.svg`)).text(),t=document.createElement(`div`);t.innerHTML=e.trim(),yp=t.firstElementChild,yp.classList.add(`play_button`)}return yp.cloneNode(!0)}function xp(e){return e===`SE`?{2:0,1:1}:null}function Sp(e,t){let n=xp(t);return n?[...e].sort((e,t)=>(n[e.category]??99)-(n[t.category]??99)):e}var Cp=Sp(_p,vp);async function wp(e,t){let n=document.createElement(`div`);if(n.className=`card`,e.video!==``){let t=document.createElement(`div`);t.className=`video-wrapper`;let r=Object.assign(document.createElement(`video`),{id:`video`+e.id,poster:e.img,preload:`metadata`,playsInline:!0,muted:!0,loop:!0}),i=await bp(),a=document.createElement(`source`);a.src=e.video,a.type=`video/mp4`,r.classList.add(`videos`),r.appendChild(a),t.appendChild(r),t.appendChild(i),n.appendChild(t)}else{let r=document.createElement(`img`);r.src=e.img,r.alt=e.title[t],n.appendChild(r)}let r=document.createElement(`div`);r.style.padding=`20px`,r.id=e.id;let i=document.createElement(`div`);i.classList.add(`card-category`);let a=gp[e.category][t];i.innerText=e.year+` • `+a;let o=document.createElement(`div`);o.classList.add(`card-header`);let s=document.createElement(`h3`);s.style.margin=`0`,s.textContent=e.title[t],o.appendChild(s);for(let t=0;t<e.tech.length;t++){let n=document.createElement(`div`);n.classList.add(`card-tech-elem`),n.innerText=e.tech[t],o.appendChild(n)}let c=document.createElement(`p`);c.textContent=e.description[t];let l=document.createElement(`a`);return l.href=e.link,l.target=`_blank`,l.textContent=e.cta[t],r.append(i,o,c,l),r.classList.add(`card-content`),n.appendChild(r),n.classList.add(`show`),n.dataset.category=e.category,n}function Tp(e){let t=document.querySelectorAll(`.card-content`);for(let n=0;n<t.length;n++){let r=_p.find(e=>e.id===parseInt(t[n].id,10));r&&(t[n].querySelector(`h3`).innerText=r.title[e],t[n].querySelector(`p`).innerText=r.description[e],t[n].querySelector(`a`).innerText=r.cta[e],t[n].querySelector(`.card-category`).innerText=r.year+` • `+gp[r.category][e])}}var Ep=[`es`,`en`],Dp={en:{nav:{home:`Home`,projects:`Projects`,about:`About`},controls_hint:{1:`Toggle forklift controls`,2:`Drive`,3:`Move fork`},degree:`Software Engineer`,sections:{home:`Home`,projects:`Projects`,about:`About`},project_cat:{all:`All`,1:`Games`,2:`Software projects`},aboutme:`I’m a software developer from Colombia focused on interactive systems and real-time applications.
                    ...
                    Sigo mejorando mis habilidades, con interés en escribir código limpio y mantenible, y tengo algo de experiencia en pruebas de seguridad que me ayuda a considerar diversos casos y confiabilidad.`,contact:{title:`Contacto`,name:`Tu nombre`,email:`Tu correo electrónico`,message:`Tu mensaje`,send_button:`Enviar Mensaje`,success_message:`Gracias! El mensaje fue enviado.`,alternative:`También puedes contactarme a través de:`}}},Op=[`TEXTAREA`,`INPUT`];function kp(e){let t=Ep.includes(e)?e:`en`;localStorage.setItem(`lang`,t),document.querySelectorAll(`[data-i18n]`).forEach(e=>{let n=e.dataset.i18n;Op.includes(e.nodeName)?e.placeholder=Ap(n,t):e.textContent=Ap(n,t)}),Tp(t)}function Ap(e,t){return e.split(`.`).reduce((e,t)=>e==null?void 0:e[t],Dp[t])}function jp(){localStorage.getItem(`lang`)||(console.log(`Language not found in localStorage. Setting it!`),navigator.language.split(`-`)[0]===`es`?localStorage.setItem(`lang`,`es`):localStorage.setItem(`lang`,`en`))}function Mp(){let e=localStorage.getItem(`lang`);return Ep.includes(e)?e:`en`}jp(),kp(Mp());function Np({baseEl:e,stickEl:t,radius:n=50,deadZone:r=.1,onStart:i=()=>{},onMove:a=()=>{},onEnd:o=()=>{}}){let s=!1,c=null,l={x:0,y:0},u={onStart:i,onMove:a,onEnd:o};function d(){let t=e.getBoundingClientRect();l.x=t.left+t.width/2,l.y=t.top+t.height/2}return e.addEventListener(`touchstart`,e=>{if(u.onStart(),s)return;let t=e.changedTouches[0];s=!0,c=t.identifier,d()}),window.addEventListener(`touchmove`,e=>{if(!s)return;let i=[...e.changedTouches].find(e=>e.identifier===c);if(!i)return;let a=i.clientX-l.x,o=i.clientY-l.y,d=Math.sqrt(a*a+o*o);d>n&&(a=a/d*n,o=o/d*n),t.style.transform=`translate(${a}px, ${o}px)`;let f=a/n,p=o/n;Math.abs(f)<r&&(f=0),Math.abs(p)<r&&(p=0),u.onMove(f,p)}),window.addEventListener(`touchend`,e=>{s&&[...e.changedTouches].find(e=>e.identifier===c)&&(s=!1,c=null,t.style.transform=`translate(0px, 0px)`,u.onEnd())}),{setOnStart(e){u.onStart=e},setOnMove(e){u.onMove=e},setOnEnd(e){u.onEnd=e},destroy(){}}}var Pp=document.querySelector(`.header-sections`);wf>768?Pp.innerHTML=`<a data-i18n="nav.home" href="#hero" class="nav-link">Home</a>
                                <a data-i18n="nav.projects" href="#projects" class="nav-link">Projects</a>
                                <a data-i18n="nav.about" href="#about" class="nav-link">About</a>`:Pp.innerHTML=`<a class="active" id="section-hint">Home</a>`;var Fp={hero:`Home`,projects:`Projects`,about:`About`},Ip=document.querySelector(`.card-grid`);for(let e of Cp){let t=await wp(e,Mp());Ip.appendChild(t)}function Lp(e){document.querySelectorAll(`.card`).forEach(t=>{let n=parseInt(t.dataset.category),r=!e||n===e;t.classList.toggle(`hide`,!r)})}document.querySelectorAll(`.projects-filter button`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.project_cat;Lp(t===`all`?null:parseInt(t)),document.querySelectorAll(`.projects-filter button`).forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`)})});var Rp=null;function zp(){if(!Rp)return;let e=Rp.closest(`.card`),t=e==null?void 0:e.querySelector(`.play_button`);Rp.pause(),t&&(t.style.display=`block`),Rp=null}function Bp(e){let t=e.parentElement.querySelector(`.play_button`);Rp&&Rp!==e&&zp(),e.paused?e.play().then(()=>{t&&(t.style.display=`none`),Rp=e}).catch(e=>console.log(`Playback failed:`,e)):(e.pause(),t&&(t.style.display=`block`),Rp=null)}var Vp=document.querySelectorAll(`.videos`);for(let e of Vp)e.addEventListener(`click`,function(e){e.stopPropagation(),Bp(this)});var Hp=new Map,Up=new IntersectionObserver(e=>{let t=0,n=null;if(e.forEach(e=>{e.isIntersecting&&(n=e.target.id)}),Hp.forEach((e,r)=>{e>t&&(t=e,n=r)}),n)if(wf>786){document.querySelectorAll(`.nav-link`).forEach(e=>e.classList.remove(`active`));let e=document.querySelector(`.nav-link[href="#${n}"]`);e&&e.classList.add(`active`)}else{let e=document.querySelector(`#section-hint`);e&&Fp[n]&&(e.setAttribute(`data-i18n`,`nav.`+Fp[n].toLowerCase()),e.textContent=Ap(e.dataset.i18n,Mp()))}},{threshold:0,rootMargin:`-50% 0px -50% 0px`});document.querySelectorAll(`section`).forEach(e=>{Hp.set(e.id,0),Up.observe(e)});var Wp=document.querySelector(`#controls_div`),Gp={forward:0,turn:0,rise:!1,lower:!1},Kp=document.querySelector(`#joystick-zone`);document.querySelector(`#move-zone`),document.querySelector(`#fork-zone`);var qp=document.querySelector(`#onJoystickToggle`),Jp,Yp;if(kf){Wp.innerHTML=`<p data-i18n="controls_hint.1"></p>
    <button class="glass-element control-btn">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M448 128C554 128 640 214 640 320C640 426 554 512 448 512L192 512C86 512 0 426 0 320C0 214 86 128 192 128L448 128zM192 240C178.7 240 168 250.7 168 264L168 296L136 296C122.7 296 112 306.7 112 320C112 333.3 122.7 344 136 344L168 344L168 376C168 389.3 178.7 400 192 400C205.3 400 216 389.3 216 376L216 344L248 344C261.3 344 272 333.3 272 320C272 306.7 261.3 296 248 296L216 296L216 264C216 250.7 205.3 240 192 240zM432 336C414.3 336 400 350.3 400 368C400 385.7 414.3 400 432 400C449.7 400 464 385.7 464 368C464 350.3 449.7 336 432 336zM496 240C478.3 240 464 254.3 464 272C464 289.7 478.3 304 496 304C513.7 304 528 289.7 528 272C528 254.3 513.7 240 496 240z"/></svg>
    </button>`;let e=document.getElementsByClassName(`toggleControls`);for(let t=0;t<e.length;t++)e[t].addEventListener(`click`,()=>{Kp.classList.contains(`hidden`),Kp.classList.toggle(`hidden`),Kp.classList.contains(`hidden`)?(qp.style.transform=`rotate(180deg)`,qp.style.bottom=`10px`):(qp.style.transform=`rotate(0deg)`,qp.style.bottom=`150px`)});Jp=Np({baseEl:document.getElementById(`move-base`),stickEl:document.getElementById(`move-stick`)}),Jp.setOnMove((e,t)=>{Gp.turn=e,Gp.forward=t}),Jp.setOnEnd((e,t)=>{Gp.turn=0,Gp.forward=-0}),Yp=Np({baseEl:document.getElementById(`fork-base`),stickEl:document.getElementById(`fork-stick`)}),Yp.setOnMove((e,t)=>{t<-.2?Gp.rise=!0:Gp.rise=!1,t>.2?Gp.lower=!0:Gp.lower=!1}),Yp.setOnEnd((e,t)=>{Gp.rise=!1,Gp.lower=!1})}else Kp.style.display=`none`,qp.style.display=`none`,Wp.innerHTML=` <div class="ctrl_hint">
                                ...
                                `;var Xp=document.querySelector(`#enbtn`),Zp=document.querySelector(`#esbtn`);function Qp(){Mp()===`es`?(Zp.classList.add(`activelang`),Xp.classList.remove(`activelang`)):(Zp.classList.remove(`activelang`),Xp.classList.add(`activelang`))}kp(Mp());function $p(e=12,t=60,n=.3){let r=Math.PI*2/e,i=[];for(let a=0;a<e;a++){let e=a*r,o=t*(1+(Math.random()*2-1)*n);i.push({x:100+Math.cos(e)*o,y:100+Math.sin(e)*o})}let a=`M ${i[0].x} ${i[0].y}`;for(let e=0;e<i.length;e++){let t=i[(e+1)%i.length],n=(i[e].x+t.x)/2,r=(i[e].y+t.y)/2;a+=` Q ${i[e].x} ${i[e].y} ${n} ${r}`}return a+=` Z`,a}function em(){return`hsl(${Math.random()*360}, ${70+Math.random()*20}%, ${50+Math.random()*10}%)`}var tm=document.getElementById(`blob-path`);tm.style.fill=em();function nm(){tm.setAttribute(`d`,$p())}nm(),Xp.addEventListener(`click`,()=>{kp(`en`),Qp()}),Zp.addEventListener(`click`,()=>{kp(`es`),Qp()});var rm=document.querySelector(`main`),im=rm.scrollHeight-rm.clientHeight;(Df.height-28-28)*1.15,Of(Lf(im));var am=new Bs;am.connect(document),am.reset();var om=new vd({canvas:document.querySelector(`#bg`),antialias:!0});om.setClearColor(0,0),console.log(window.innerWidth),console.log(window.innerHeight),om.setSize(window.innerWidth,window.innerHeight),om.shadowMap.enabled=!0,om.setPixelRatio(Math.min(window.devicePixelRatio,2)),window.addEventListener(`resize`,sm);function sm(){Ef(window.innerWidth,window.innerHeight);let e=wf/Tf,t=Tf/951,n=Et.clamp(t,.7,1.1),r=70*Et.lerp(1,n,.3);Nf.left=-r*e/2,Nf.right=r*e/2,Nf.top=r/2,Nf.bottom=-r/2,Nf.updateProjectionMatrix(),om.setSize(wf,Tf),om.setPixelRatio(Math.min(window.devicePixelRatio,2)),Of(Lf(rm.scrollHeight-rm.clientHeight));let i=document.getElementById(`hero`);i.style.height=`${Bf(35)}px`}var cm={w:!1,a:!1,s:!1,d:!1,i:!1,k:!1},lm=!1;window.addEventListener(`keydown`,e=>{hm(e)||e.key in cm&&(cm[e.key]=!0,um(!0))}),window.addEventListener(`keyup`,e=>{hm(e)||e.key in cm&&(cm[e.key]=!1)}),window.addEventListener(`wheel`,()=>{um(!1)}),Jp!==void 0&&Jp.setOnStart(()=>{um(!0)}),window.addEventListener(`blur`,()=>{dm(),um(!1)}),window.addEventListener(`contextmenu`,()=>{dm(),um(!1)}),window.addEventListener(`mouseup`,()=>{dm()}),document.addEventListener(`visibilitychange`,()=>{document.hidden&&(dm(),um(!1))}),rm.scrollTop,rm.addEventListener(`touchmove`,()=>{um(!1)},{passive:!1}),rm.addEventListener(`scroll`,()=>{lm||rm.scrollTop});function um(e){lm=e,lm?(rm.style.overflow=`hidden`,document.body.style.overflow=`hidden`):(rm.style.overflow=``,document.body.style.overflow=``)}function dm(){Object.keys(cm).forEach(e=>cm[e]=!1)}var fm=document.getElementById(`hero`);fm.style.height=`${Bf(35)}px`;var pm=new yd;document.body.appendChild(pm.dom),document.querySelector(`#controls_div`);var mm=document.getElementById(`contact-form`);mm.addEventListener(`submit`,async e=>{e.preventDefault();let t=new FormData(mm);await fetch(mm.action,{method:`POST`,body:t,headers:{Accept:`application/json`}}),mm.style.display=`none`,document.getElementById(`success-message`).style.display=`block`});function hm(e){let t=e.target.tagName;return t===`INPUT`||t===`TEXTAREA`}document.querySelectorAll(`.nav-link`).forEach(e=>{e.addEventListener(`click`,()=>{dm(),um(!1)})});var gm=document.getElementById(`forklift-blob`);function _m(){let e=$f.position.clone().project(Nf),t=(e.x*.5+.5)*window.innerWidth,n=(-e.y*.5+.5)*window.innerHeight;gm.style.left=`${t}px`,gm.style.top=`${n}px`}var vm=tp.position.y,ym=document.getElementById(`blob-path`);function bm(){let e=tp.position.y;Math.abs(e-vm)>1.8&&(vm=e,nm(),ym.style.fill=em())}var xm=Nf.position.z,Sm=25,Cm=28+Sm,wm=Df.height-28+Sm,Tm=function(){requestAnimationFrame(Tm),am.update(),mp(cm,Gp,am.getDelta());let e=rm.scrollHeight-rm.clientHeight,t=wm-Cm;if(lm){let n=$f.position.z+Sm,r=Et.clamp(n,Cm,wm);Nf.position.z+=(r-Nf.position.z)*.2;let i=Et.clamp(($f.position.z+Sm-Cm)/t,0,1)*e;rm.scrollTo({top:i,behavior:`auto`})}else{let t=e>0?rm.scrollTop/e:0;xm=Et.lerp(Cm,wm,t),Nf.position.z=xm}_m(),bm(),If.position.set(-15,40,Nf.position.z-40),If.target.position.set(0,0,Nf.position.z-40),om.render(Cf,Nf),pm.update()};Tm();