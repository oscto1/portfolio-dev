...
`)c=0,l-=o;else{let e=Gf(t,a,c,l,n);r==`tb`?(c=0,l+=n.ascender*a):c+=e.offsetX,s.push(e.path)}}return s}function Gf(e,t,n,r,i){let a=i.glyphs[e]||i.glyphs[`?`];if(!a){console.error(`THREE.Font: character "`+e+`" does not exists in font family `+i.familyName+`.`);return}let o=new ec,s,c,l,u,d,f,p,m;if(a.o){let e=a._cachedOutline||(a._cachedOutline=a.o.split(` `));for(let i=0,a=e.length;i<a;)switch(e[i++]){case`m`:s=e[i++]*t+n,c=e[i++]*t+r,o.moveTo(s,c);break;case`l`:s=e[i++]*t+n,c=e[i++]*t+r,o.lineTo(s,c);break;case`q`:l=e[i++]*t+n,u=e[i++]*t+r,d=e[i++]*t+n,f=e[i++]*t+r,o.quadraticCurveTo(d,f,l,u);break;case`b`:l=e[i++]*t+n,u=e[i++]*t+r,d=e[i++]*t+n,f=e[i++]*t+r,p=e[i++]*t+n,m=e[i++]*t+r,o.bezierCurveTo(d,f,p,m,l,u);break}}return{offsetX:a.ha*t,path:o}}var Kf=new Sd,qf=new Hf;async function Jf(e,t){let n=await Kf.loadAsync(e);return t.add(n.scene),n.scene}function Yf(e){let t=e.geometry;t.computeBoundingBox();let n=t.boundingBox,r=n.max.x-n.min.x,i=n.max.y-n.min.y,a=n.max.z-n.min.z;t.translate(-r/2,-i/2,-a/2)}function Xf(e,t,n,r){let i=new Na,a=-e/2,o=-t/2;i.moveTo(a+r,o),i.lineTo(a+e-r,o),i.quadraticCurveTo(a+e,o,a+e,o+r),i.lineTo(a+e,o+t-r),i.quadraticCurveTo(a+e,o+t,a+e-r,o+t),i.lineTo(a+r,o+t),i.quadraticCurveTo(a,o+t,a,o+t-r),i.lineTo(a,o+r),i.quadraticCurveTo(a,o,a+r,o);let s=new Zr(new vo(i,{depth:n,bevelEnabled:!1}),new Mo({color:15779883}));return s.rotation.x=-Math.PI/2,s}var Zf=Xf(23,7,3,1);Zf.castShadow=!0,Sf.add(Zf),qf.load(`fonts/dongle/Dongle_Bold.json`,e=>{let t=new Zr(new Vf(`oscar`,{font:e,size:9,depth:1.5,curveSegments:12,bevelEnabled:!0,bevelThickness:.08,bevelSize:.07,bevelSegments:3}),new Mo({color:16777215}));np(t),Yf(t),t.position.set(Zf.position.x,4,Zf.position.z),Sf.add(t)}),qf.load(`fonts/Finesse-Oblique/FinesseOblique_Regular.json`,e=>{let t=new Zr(new Vf(`Castillejo`,{font:e,size:6,depth:0,curveSegments:12,bevelEnabled:!0,bevelThickness:.08,bevelSize:.07,bevelSegments:3}),new Mo({color:16777215}));np(t),Yf(t),t.position.set(Zf.position.x,.1,6),t.receiveShadow=!0,Sf.add(t)});var Qf=await Jf(`models/Forklift.glb`,Sf);Qf.position.set(0,0,14),Qf.rotation.y=.78,Qf.scale.set(1,1,1),Qf.castShadow=!0;var $f=await Jf(`models/Fork.glb`,Qf);$f.position.set(0,.3,3.1),Qf.traverse(e=>{if(e.isMesh){var t;e.castShadow=!0,e.name===`Cube`&&((t=e.parent)==null||t.name)}});var ep=1024,tp=new Zr(new xo(ep,ep),new So({opacity:.3}));np(tp),tp.receiveShadow=!0,Sf.add(tp);function np(e){e.rotation.x=-Math.PI/2}var rp=0,ip=.03,ap=.95,op=.8,sp=new K;function cp(e,t,n){let r=n*60,i=!!e.a-+!!e.d+-t.turn;(e.w||t.forward<0)&&(rp+=ip*Math.max(1,t.forward)*r),(e.s||t.forward>0)&&(rp-=ip*Math.max(1,t.forward)*r),rp*=ap**+r;let a=.03*Math.min(Math.abs(rp)/op,1)*r;sp.set(0,0,1).applyQuaternion(Qf.quaternion),Qf.position.addScaledVector(sp,rp*r),Qf.rotation.y+=i*a*Math.sign(rp);let o=$f.position;e.i&&o.y<=4&&$f.position.set(0,o.y+=.15*r,3.1),e.k&&o.y>=.3&&$f.position.set(0,o.y-=.15*r,3.1),Qf.position.x=Et.clamp(Qf.position.x,-Ef.width/2,Ef.width/2),Qf.position.z=Et.clamp(Qf.position.z,0,Ef.height)}var lp={1:{en:`Games`,es:`Juegos`},2:{en:`Software projects`,es:`Proyectos de software`}},up=[{id:1,year:`2025 - 2026`,title:{en:`Forkfest`,es:`Forkfest`},category:1,description:{en:`C#, Multiplayer application with client-server synchronization and gameplay systems implemented using Unity NGO.`,es:`Aplicación multijugador en C# con sincronización cliente-servidor y sistemas de juego implementado usando Unity NGO.`},tech:[`C#`,`Unity`,`NGO`],cta:{en:`Check updates`,es:`Ver avances`},link:`https://www.instagram.com/olliqadev/`,img:`img/forkfest/thumbnail.png`,video:`img/forkfest/forkfest.mp4`},{id:2,year:`2023`,title:{en:`Math Slopes`,es:`Math Slopes`},category:1,description:{en:`Browser-based application built with Phaser (JavaScript), implementing game state management, input handling, scoring logic, and dynamic difficulty.`,es:`Aplicación para navegador desarrollada con Phaser (JavaScript), que implementa la gestión de estados de juego, manejo de entradas, lógica de puntuación y dificultad dinámica.`},tech:[`PhaserJS`],cta:{en:`Try now`,es:`Probar ahora`},link:`project/ski_slopes/index.html`,img:`img/ski/1.png`,video:`img/ski/1.mp4`},{id:3,year:`2021`,title:{en:`Unity Arcade`,es:`Arcade Unity`},category:1,description:{en:`C#, Unity project recreating some classic arcade mechanics , implementing input handling, collision detection, scoring systems, and basic UI logic.`,es:`Proyecto en C# y Unity que recrea mecánicas de algunos juegos arcade e implementa el manejo de entradas, la detección de colisiones y lógica de interfaz de usuario.`},tech:[`C#`,`Unity`],cta:{en:`Try now`,es:`Probar ahora`},link:`Arcade/arcade.html`,img:`img/arcade/arcade1.png`,video:`img/arcade/arcade1.mp4`},{id:4,year:`2025`,title:{en:`Sort Algorithms`,es:`Algoritmos de ordenamiento`},category:2,description:{en:`Interactive visualization tool demonstrating sorting algorithms (Merge, Quick, Heap, Bubble), including step-by-step execution.`,es:`Herramienta de visualización interactiva que muestra algoritmos de ordenamiento (Merge, Quick, Heap, Bubble), con ejecución paso a paso.`},tech:[`Javascript`],cta:{en:`Try now`,es:`Probar ahora`},link:`project/sort_visualizer/index.html`,img:`img/sort_visualizer/1.png`,video:`img/sort_visualizer/1.mp4`},{id:5,year:`2021`,title:{en:`Messapp`,es:`Messapp`},category:2,description:{en:`Chat room application built with React and Firebase, implementing messaging, Google authentication, and cloud-based data synchronization.`,es:`Aplicación de salas de chat desarrollada con React y Firebase, que incluye funciones de mensajería, autenticación de Google y sincronización de datos en la nube.`},tech:[`React`,`Firebase`],cta:{en:`Try now`,es:`Probar ahora`},link:`https://messa-69e78.firebaseapp.com/`,img:`img/messaging/Messa2-min.png`,video:``}],dp=new URLSearchParams(window.location.search).get(`type`),fp=null;async function pp(){if(!fp){let e=await(await fetch(`img/icons/play-video.svg`)).text(),t=document.createElement(`div`);t.innerHTML=e.trim(),fp=t.firstElementChild,fp.classList.add(`play_button`)}return fp.cloneNode(!0)}function mp(e){return e===`SE`?{2:0,1:1}:null}function hp(e,t){let n=mp(t);return n?[...e].sort((e,t)=>(n[e.category]??99)-(n[t.category]??99)):e}var gp=hp(up,dp);async function _p(e,t){let n=document.createElement(`div`);if(n.className=`card`,e.video!==``){let t=document.createElement(`div`);t.className=`video-wrapper`;let r=Object.assign(document.createElement(`video`),{id:`video`+e.id,poster:e.img,preload:`metadata`,playsInline:!0,muted:!0,loop:!0}),i=await pp(),a=document.createElement(`source`);a.src=e.video,a.type=`video/mp4`,r.classList.add(`videos`),r.appendChild(a),t.appendChild(r),t.appendChild(i),n.appendChild(t)}else{let r=document.createElement(`img`);r.src=e.img,r.alt=e.title[t],n.appendChild(r)}let r=document.createElement(`div`);r.style.padding=`20px`,r.id=e.id;let i=document.createElement(`div`);i.classList.add(`card-category`);let a=lp[e.category][t];i.innerText=e.year+` • `+a;let o=document.createElement(`div`);o.classList.add(`card-header`);let s=document.createElement(`h3`);s.style.margin=`0`,s.textContent=e.title[t],o.appendChild(s);for(let t=0;t<e.tech.length;t++){let n=document.createElement(`div`);n.classList.add(`card-tech-elem`),n.innerText=e.tech[t],o.appendChild(n)}let c=document.createElement(`p`);c.textContent=e.description[t];let l=document.createElement(`a`);return l.href=e.link,l.target=`_blank`,l.textContent=e.cta[t],r.append(i,o,c,l),r.classList.add(`card-content`),n.appendChild(r),n.classList.add(`show`),n.dataset.category=e.category,n}function vp(e){let t=document.querySelectorAll(`.card-content`);for(let n=0;n<t.length;n++){let r=up.find(e=>e.id===parseInt(t[n].id,10));r&&(t[n].querySelector(`h3`).innerText=r.title[e],t[n].querySelector(`p`).innerText=r.description[e],t[n].querySelector(`a`).innerText=r.cta[e],t[n].querySelector(`.card-category`).innerText=r.year+` • `+lp[r.category][e])}}var yp=[`es`,`en`],bp={en:{nav:{home:`Home`,projects:`Projects`,about:`About`},controls_hint:{1:`Toggle forklift controls`,2:`Drive`,3:`Move fork`},degree:`Software Engineer`,sections:{home:`Home`,projects:`Projects`,about:`About`},project_cat:{all:`All`,1:`Games`,2:`Software projects`},aboutme:`I’m a software developer from Colombia focused on interactive systems and real-time applications.
    ...
    <button class="glass-element control-btn">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M448 128C554 128 640 214 640 320C640 426 554 512 448 512L192 512C86 512 0 426 0 320C0 214 86 128 192 128L448 128zM192 240C178.7 240 168 250.7 168 264L168 296L136 296C122.7 296 112 306.7 112 320C112 333.3 122.7 344 136 344L168 344L168 376C168 389.3 178.7 400 192 400C205.3 400 216 389.3 216 376L216 344L248 344C261.3 344 272 333.3 272 320C272 306.7 261.3 296 248 296L216 296L216 264C216 250.7 205.3 240 192 240zM432 336C414.3 336 400 350.3 400 368C400 385.7 414.3 400 432 400C449.7 400 464 385.7 464 368C464 350.3 449.7 336 432 336zM496 240C478.3 240 464 254.3 464 272C464 289.7 478.3 304 496 304C513.7 304 528 289.7 528 272C528 254.3 513.7 240 496 240z"/></svg>
    </button>`;let e=document.getElementsByClassName(`toggleControls`);for(let t=0;t<e.length;t++)e[t].addEventListener(`click`,()=>{zp.classList.contains(`hidden`),zp.classList.toggle(`hidden`),zp.classList.contains(`hidden`)?(Bp.style.transform=`rotate(180deg)`,Bp.style.bottom=`10px`):(Bp.style.transform=`rotate(0deg)`,Bp.style.bottom=`150px`)});Vp=Ep({baseEl:document.getElementById(`move-base`),stickEl:document.getElementById(`move-stick`)}),Vp.setOnMove((e,t)=>{Rp.turn=e,Rp.forward=t}),Vp.setOnEnd((e,t)=>{Rp.turn=0,Rp.forward=-0})}else zp.style.display=`none`,Bp.style.display=`none`,Lp.innerHTML=` <div class="ctrl_hint">
                                ...
                                `;var Hp=document.querySelector(`#enbtn`),Up=document.querySelector(`#esbtn`);function Wp(){Tp()===`es`?(Up.classList.add(`activelang`),Hp.classList.remove(`activelang`)):(Up.classList.remove(`activelang`),Hp.classList.add(`activelang`))}Sp(Tp()),Hp.addEventListener(`click`,()=>{Sp(`en`),Wp()}),Up.addEventListener(`click`,()=>{Sp(`es`),Wp()});var Gp=document.querySelector(`main`),Kp=Gp.scrollHeight-Gp.clientHeight;(Ef.height-28-28)*1.15,Df(If(Kp));var qp=new Bs;qp.connect(document),qp.reset();var Jp=new _d({canvas:document.querySelector(`#bg`),antialias:!0});Jp.setClearColor(0,0),console.log(window.innerWidth),console.log(window.innerHeight),Jp.setSize(window.innerWidth,window.innerHeight),Jp.shadowMap.enabled=!0,Jp.setPixelRatio(Math.min(window.devicePixelRatio,2)),window.addEventListener(`resize`,Yp);function Yp(){Tf(window.innerWidth,window.innerHeight);let e=Cf/wf,t=wf/951,n=Et.clamp(t,.7,1.1),r=70*Et.lerp(1,n,.3);Mf.left=-r*e/2,Mf.right=r*e/2,Mf.top=r/2,Mf.bottom=-r/2,Mf.updateProjectionMatrix(),Jp.setSize(Cf,wf),Jp.setPixelRatio(Math.min(window.devicePixelRatio,2)),Df(If(Gp.scrollHeight-Gp.clientHeight));let i=document.getElementById(`hero`);i.style.height=`${zf(35)}px`}var Xp={w:!1,a:!1,s:!1,d:!1,i:!1,k:!1},Zp=!1;window.addEventListener(`keydown`,e=>{rm(e)||e.key in Xp&&(Xp[e.key]=!0,Qp(!0))}),window.addEventListener(`keyup`,e=>{rm(e)||e.key in Xp&&(Xp[e.key]=!1)}),window.addEventListener(`wheel`,()=>{Qp(!1)}),Vp!==void 0&&Vp.setOnStart(()=>{Qp(!0)}),window.addEventListener(`blur`,()=>{$p(),Qp(!1)}),window.addEventListener(`contextmenu`,()=>{$p(),Qp(!1)}),window.addEventListener(`mouseup`,()=>{$p()}),document.addEventListener(`visibilitychange`,()=>{document.hidden&&($p(),Qp(!1))}),Gp.scrollTop,Gp.addEventListener(`touchmove`,()=>{Qp(!1)},{passive:!1}),Gp.addEventListener(`scroll`,()=>{Zp||Gp.scrollTop});function Qp(e){Zp=e,Zp?(Gp.style.overflow=`hidden`,document.body.style.overflow=`hidden`):(Gp.style.overflow=``,document.body.style.overflow=``)}function $p(){Object.keys(Xp).forEach(e=>Xp[e]=!1)}var em=document.getElementById(`hero`);em.style.height=`${zf(35)}px`;var tm=new vd;document.body.appendChild(tm.dom),document.querySelector(`#controls_div`);var nm=document.getElementById(`contact-form`);nm.addEventListener(`submit`,async e=>{e.preventDefault();let t=new FormData(nm);await fetch(nm.action,{method:`POST`,body:t,headers:{Accept:`application/json`}}),nm.style.display=`none`,document.getElementById(`success-message`).style.display=`block`});function rm(e){let t=e.target.tagName;return t===`INPUT`||t===`TEXTAREA`}document.querySelectorAll(`.nav-link`).forEach(e=>{e.addEventListener(`click`,()=>{$p(),Qp(!1)})});var im=Mf.position.z,am=25,om=28+am,sm=Ef.height-28+am,cm=function(){requestAnimationFrame(cm),qp.update(),cp(Xp,Rp,qp.getDelta());let e=Gp.scrollHeight-Gp.clientHeight,t=sm-om;if(Zp){let n=Qf.position.z+am,r=Et.clamp(n,om,sm);Mf.position.z+=(r-Mf.position.z)*.2;let i=Et.clamp((Qf.position.z+am-om)/t,0,1)*e;Gp.scrollTo({top:i,behavior:`auto`})}else{let t=e>0?Gp.scrollTop/e:0;im=Et.lerp(om,sm,t),Mf.position.z=im}Ff.position.set(-15,40,Mf.position.z-40),Ff.target.position.set(0,0,Mf.position.z-40),Jp.render(Sf,Mf),tm.update()};cm();